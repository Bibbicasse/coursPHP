...
<html lang="fr">
  ...
  <body>
    ...
    <div class="jumbotron">
        <h1 class="display-4">Cours PHP 7 - Types</h1>
        <p class="lead">Dans PHP, il n'existe pas de déclaration explicite du type d'une variable lors de sa création</p>
    <hr class="my-4">
    ...
    <table class="table table-primary table-striped">
        ...
        <p>Le type booléen ne peux contenir 2 valeurs différentes (TRUE ou FALSE, 1 ou 0</p>

        <?php 
            $a = 89;
            $b = ($a<100);//dans le cas où c'est FALSE il affichera une chaine vide
            echo "<div class=\"border border-warning w-50 p-2\"> \$b vaut $b</div>";
        ?>

        <h3>Les opérateurs Boléens</h3>
        <p>Quand ils sont associés, les opérateurs booléens servent à écrire des expressions simples ou complexes, qui sont par une valeur booléenne TRUE ou FALSE. Ils seront utilisés dans les instructions conditionnelles.</p>
        <table class="table table-striped">
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
					    <th scope="row">||</th>
					    <td>Équivaut à l'opérateur OR mais n'a pas la même priorité.
                        </td>
					</tr>
					<tr>
					    <th scope="row">XOR</th>
                    ...
                    <tr>
					    <th scope="row">&&</th>
					    <td>Équivaut à l'opérateur AND mais n'a pas la même priorité.
                        </td>
					</tr>
					<tr>
					    <th scope="row">!</th>
            ...
            <p>Attention !! Une erreur classique dans l'écriture des expressions conditionnelles consiste à confondre l'opérateur de comparaison == avec l'opérateur d'affectation =. L'usage des parenthèses dans la rédaction des expressions booléennes est souvent indispensable et toujours pour éviter les problèmes liés à l'ordre d'évaluation des opérateurs.</p>
