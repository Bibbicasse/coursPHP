  ...
  <?php 
    ...
    <main class="container bg-white">
        <div class="row">
            <div class="col-sm-12 ">
                <h2>Les variables</h2>
                <p>Chaque variable possède un identifiant particulier, qui commance toujours par le caractère dollar ($) suivi du nom de la variable. Les règles de création des nom de variables sont les suivantes :</p>
                <ul>
                    ...
                    <li>
                    <?php 
                        echo"<p>Nom de fichier inclus : ". __FILE__ ." </p>";//donne le nom du ficier que vous consulter
                    ?>
                    </li>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <p>l'affectation consite à donner une valeur à une variable. lors de la création d'une variable, vous ne déclarez pas son type. C'est la valeur que vous lui affectez qui détermone ce type. Dans PHP, vous pouvez affecter une variable par valeur ou par référence.</p>
                <p>Exemple</p>
                <ul>
                    <li>$mavar=75;</li>
                    <li>$mavar="Paris";</li>
        ...
        <div class="row">
            <div class="col-sm-12 ">
                <h2>Le variables prédéfinies</h2>
                <p>PHP dispose d'un grand nombre de variable prédéfinies, qui contiennet des informations à la fois sur le serveur et sur toutes les données qui peuvent transiter entre le poste client et le serveur, comme les valeurs saisies dans un formulaire, les cookies ou les sessions.</p>
            ...
            <div class="col-sm-12">
                ...
                <p>En plus de l'opérateur classique d'affectation =, il existe plusieurs opérateur d'affectation combinée. Ces opérateurs réalisent à la fois une opération entre deux opérandes et l'affectation du résultat à l'opérande de gauche</p>
                <table class="table table-striped">
					<thead>
						<tr>
            ...
            <div class="col-sm-12">
				...
				<p>On peut définir ses constantes soi-même cf. ; Pour définir des constantes personnalisées, utilisez la fonction define(), dont la syntaxe est la suivante : <strong>boolean define(string nom_cte, divers valeur_cte, boolean casse)</strong> Voir la page <a href="../00_pages/03_page.php" target="_blank">suivante</a></p>

                <h3>Les constante prédéfinies</h3>
                <p>Il existe dans PHP un grand nombre de constantes prédéfinies, que vous pouvez notamment utiliser dans les fonctions comme paramètres permettant de définir des options. Nous ne pouvons les citer toutes tant elles sont nombreuses, mais nous les définirons au fur et à mesure de nos besoins. Voir la page <a href="#">avec un exemple</a></p>
                <table class="table table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <td>PHP_VERSION : <?php echo "<p>Numéro de la ligne : n° ".PHP_VERSION."</p>"?></td>
                        </tr>
                        <tr>
                        <th scope="row">PHP_OS</th>
                        <td>Nom du système d'exploitation du serveur: <?php echo "<p>Numéro de la ligne : n° ".PHP_OS."</p>"?></td>
                        </tr>
                        <tr>
                        <th scope="row">DEFAULT_INCLUDE_PATH</th>
                        <td>Chemin d'accès aux fichiers par défaut : <?php echo "<p>Numéro de la ligne : n° ".DEFAULT_INCLUDE_PATH."</p>"?></td>
                        </tr>
                        <tr>
                        <th scope="row">__FILE__</th>
                        <td>Nom du fichier en cours d'exécution : <?php echo "<p>Numéro de la ligne : n° ".__FILE__."</p>"?></td>
                        </tr>
                        <tr>
                        <th scope="row">__LINE__</th>
                        <td>Numéro de la ligne en cours d'exécution : <?php echo "<p>Numéro de la ligne : n° ".__LINE__."</p>"?></td></tr>
                    </tbody>
                </table>
            </div>
        </div><!-- fin row -->
